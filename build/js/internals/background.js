...
var getPoint = function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee() {
        var member_id = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'b08d3b24-0ce7-4b8a-aaf2-e1dad1bee0d3';
        var sent, received, clapped, sumReceive, sumSent;
        return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        sent = makeRequest('sent', member_id);
                        received = makeRequest('received', member_id);
                        clapped = makeRequest('clapped', member_id);
                        sumReceive = 0;
                        sumSent = 0;
                        _context.next = 7;
                        return Promise.all([sent, received, clapped]).then(function (value) {
                            for (var index = 0; index < value[0].length; index++) {
                                sumReceive += value[0][index].point + value[0][index].praise_count;
                            }
                            for (var _index = 0; _index < value[1].length; _index++) {
                                sumReceive += value[1][_index].praise_count;
                                sumSent += value[1][_index].point;
                            }
                            for (var _index2 = 0; _index2 < value[2].length; _index2++) {
