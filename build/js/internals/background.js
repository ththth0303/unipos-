...
var getReceived = function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee(type, member_id) {
        var sent, offset_card_id, result, key;
        return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        sent = { point: 0, clap: 0, time: 0 };
                        offset_card_id = '';
                    ...
                    case 2:
                        ...
                        _context.next = 5;
                        return makeRequest(type, member_id, offset_card_id);
    ...
    return function getReceived(_x, _x2) {
        return _ref.apply(this, arguments);
    };
}();

var getPoint = function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee2(member_id) {
        var sent, received, clapped, sumReceive, sumSent;
        return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee2$(_context2) {
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        sent = getReceived('send', member_id);
                        received = getReceived('received', member_id);
                        clapped = getReceived('clapped', member_id);
                        sumReceive = 0;
                        sumSent = 0;
                        _context2.next = 7;
                        return Promise.all([sent, received, clapped]).then(function (value) {
                            console.log(value);
                            ...
                            var html = '<div style="padding-left: 25px">Cumulative: <span class="sidePoint_total-num" style="margin-right: 15px;color: blue" > ' + sumReceive + '/' + value[0].time + 'time</span>    Sent:<span class="sidePoint_total-num" style="color:red"> ' + sumSent + '/' + value[1].time + 'time</span></div>';
                            var html1 = '<div class="ownProfile_groups">Cumulative: <span class="sidePoint_total-num" style="margin-right: 15px;color: blue" >  ' + sumReceive + '/' + value[0].time + '</span>    Sent:<span class="sidePoint_total-num" style="color:red"> ' + sumSent + '</span></div>';
